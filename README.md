...
This is meaningful because the model learns non-linear seasonal interactions (e.g., the Monday after a long weekend) and benefits from lag features - `lag_1h`, `lag_24h`, `lag_168h` - giving it genuine predictive power rather than just a single mean. It also enables more interpretable alerts vs. a raw z-score.
